...
class Chatter extends ActiveRecord\Model {

    static $table_name = 'chatters';
    ...
    static $has_many = array(
        ...
        array('messaggi_inviati', 'class_name' => 'Messaggio',  'primary_key' => 'id', 'foreign_key' => 'mittente'),
        array('messaggi_ricevuti', 'class_name' => 'Messaggio',  'primary_key' => 'id', 'foreign_key' => 'destinatario')
    ...
    static $has_one = array(
        ...
        array('evento', 'class_name' => 'Evento', 'primary_key' => 'id_evento', 'foreign_key' => 'id')
    );

    /* IMPORTANTE PER AUTOFORM!*/
    function _arrayEsclusione() {
        return Chatter::$arrayEsclusione;
    }
