...
class Progetto extends ActiveRecord\Model {

    static $table_name = 'progetti';
    ...
    static $has_many = array(
        ...
        array('immagini', 'class_name' => 'Immagine', 'foreign_key' => 'id_progetto')
    ...
    static $has_one = array(
        ...
        array('autore', 'class_name' => 'Utente', 'primary_key' => 'id_proprietario', 'foreign_key' => 'id')
    );

    /* IMPORTANTE PER AUTOFORM!*/
    function _arrayEsclusione() {
        return Progetto::$arrayEsclusione;
    }
